...
public class TextNicer {
    ...
    public static void showDialog(Activity parentActivity, ChatActivity parentFragment) {
        if (parentActivity != null && parentFragment != null) {
            ...
            }; builder.setItems(items, (dialogInterface, i) -> SharedStorage.basicFont(i)
            );
    ...
    public static ArrayList<String> arraysplator(ArrayList list , int nicerMode ) {
//        boolean hasNotEmoji = preferences.getBoolean("setbooleanch", true);
//        String emoji = preferences.getString("setspacecharachter", "❤");
