...
public class DialogBottomMenuSettingsActivity extends BaseFragment
        implements NotificationCenter.NotificationCenterDelegate {

    private RecyclerListView listView;
    private DialogBottomMenuLayoutAdapter adapter;


    private DialogBottomMenuLayoutAdapter.DialogType dialogType;
    String before = "";

    public DialogBottomMenuSettingsActivity(DialogBottomMenuLayoutAdapter.DialogType type) {
        this.dialogType = type;
        before = DialogBottomMenuHiddenController.get();
    }

    public DialogBottomMenuSettingsActivity() {
        this(DialogBottomMenuLayoutAdapter.DialogType.ALL);
    }
    ...
    public boolean onFragmentCreate() {
        ...
        NotificationCenter.getInstance(currentAccount)
                .addObserver(this, NotificationCenter.notificationsSettingsUpdated);
    ...
    public void onFragmentDestroy() {
        ...
        NotificationCenter.getInstance(currentAccount)
                .removeObserver(this, NotificationCenter.notificationsSettingsUpdated);
    }
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(
                LocaleController.getString("DialogBottomMenuSetting", R.string.DialogBottomMenuSetting));
        ...
        listView.setAdapter(adapter = new DialogBottomMenuLayoutAdapter(context, 0, true, false, dialogType));
        listView.setOnItemClickListener((view, position, x, y) -> {
            if (getParentActivity() == null) {
                return;
            }
            if (view instanceof DialogBottomActionCell) {
                boolean enabled = ((DialogBottomActionCell) view).isChecked();
                int id = adapter.getId(position);
                if (enabled) {
                    DialogBottomMenuHiddenController.add(id);
                } else {
                    DialogBottomMenuHiddenController.remove(id);
                }
                ((DialogBottomActionCell) view).setChecked(!enabled);
            }
            String after = DialogBottomMenuHiddenController.get();
