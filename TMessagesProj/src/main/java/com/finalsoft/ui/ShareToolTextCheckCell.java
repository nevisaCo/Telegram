...
public class ShareToolTextCheckCell extends FrameLayout {
    ...
    public static final Property<ShareToolTextCheckCell, Float> ANIMATION_PROGRESS = new AnimationProperties.FloatProperty<ShareToolTextCheckCell>("animationProgress") {
        @Override
        public void setValue(ShareToolTextCheckCell object, float value) {
            object.setAnimationProgress(value);
            object.invalidate();
        }

        @Override
        public Float get(ShareToolTextCheckCell object) {
            return object.animationProgress;
        }
    };

    public ShareToolTextCheckCell(Context context) {
        this(context, 21);
    }

    public ShareToolTextCheckCell(Context context, int padding) {
        this(context, padding, false);
    }

    public ShareToolTextCheckCell(Context context, int padding, boolean dialog) {
        super(context);
