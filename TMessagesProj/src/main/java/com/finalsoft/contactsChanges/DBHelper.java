...
public class DBHelper {
   ...
   public Cursor getData(int type, int take) {
      String var3;
      if(type != 0) {
         var3 = "type=" + type;
      } else {
      ...
      return mupdateDbHelepr.getReadableDatabase().query("tbl_update", (String[])null, var3, (String[])null, (String)null, (String)null, "_id DESC", take + "");
   }

   public com.finalsoft.contactsChanges.Teleh.a.a a(Long var1, boolean var2) {
      List var3 = this.a("_id=" + var1, var2);
       com.finalsoft.contactsChanges.Teleh.a.a var4;
      if(var3.size() > 0) {
         var4 = (com.finalsoft.contactsChanges.Teleh.a.a)var3.get(0);
      } else {
         var4 = null;
      }
   ...
   public com.finalsoft.contactsChanges.Teleh.c.a a(Long var1) {
      List list = this.a("chatID=" + var1);
       com.finalsoft.contactsChanges.Teleh.c.a var3;
      if(list.size() > 0) {
         var3 = (com.finalsoft.contactsChanges.Teleh.c.a)list.get(0);
      } else {
         var3 = null;
      }
   ...
   public UpdateModel updateModel(Cursor cursor) {
      boolean bool = false;
   ...
   public Long a(com.finalsoft.contactsChanges.Teleh.a.a var1) {
   ...
   public Long a(com.finalsoft.contactsChanges.Teleh.c.a var1) {
      SQLiteDatabase var4 = mupdateDbHelepr.getWritableDatabase();
      var4.beginTransaction();
   ...
   public Long a(com.finalsoft.contactsChanges.Teleh.e.a var1) {
      SQLiteDatabase var4 = mupdateDbHelepr.getWritableDatabase();
      var4.beginTransaction();
   ...
   public Long a(com.finalsoft.contactsChanges.Teleh.f.a var1) {
      SQLiteDatabase var4 = mupdateDbHelepr.getWritableDatabase();
      var4.beginTransaction();
      boolean var8 = false;
   ...
   public List a(String str, boolean z) {
      ...
      try {
         ...
         while (query.moveToNext()) {
            try {
                com.finalsoft.contactsChanges.Teleh.c.a e = c(query);
               if (z) {
                  d().addAll(f(e.a()));
               }
               arrayList.add(e);
   ...
   public com.finalsoft.contactsChanges.Teleh.c.a c(Cursor var1) {
      return new com.finalsoft.contactsChanges.Teleh.c.a(Long.valueOf(var1.getLong(var1.getColumnIndex("_id"))), Long.valueOf(var1.getLong(var1.getColumnIndex("chatID"))));
   }

   public com.finalsoft.contactsChanges.Teleh.e.a c(Long var1) {
      List var2 = this.b("dialogID=" + var1);
       com.finalsoft.contactsChanges.Teleh.e.a var3;
      if(var2.size() > 0) {
         var3 = (com.finalsoft.contactsChanges.Teleh.e.a)var2.get(0);
      } else {
         var3 = null;
      }
   ...
   public com.finalsoft.contactsChanges.Teleh.e.a d(Cursor var1) {
      return new com.finalsoft.contactsChanges.Teleh.e.a(Long.valueOf(var1.getLong(var1.getColumnIndex("_id"))), Long.valueOf(var1.getLong(var1.getColumnIndex("dialogID"))));
   }
   ...
   public com.finalsoft.contactsChanges.Teleh.a.a e(Cursor var1) {
      return new com.finalsoft.contactsChanges.Teleh.a.a(Long.valueOf(var1.getLong(var1.getColumnIndex("_id"))), var1.getString(var1.getColumnIndex("name")), Integer.valueOf(var1.getInt(var1.getColumnIndex("priority"))));
   }
   ...
   public com.finalsoft.contactsChanges.Teleh.f.a f(Cursor var1) {
      return new com.finalsoft.contactsChanges.Teleh.f.a(Long.valueOf(var1.getLong(var1.getColumnIndex("_id"))), Long.valueOf(var1.getLong(var1.getColumnIndex("doc_id"))), Integer.valueOf(var1.getInt(var1.getColumnIndex("priority"))));
   }
