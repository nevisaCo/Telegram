...
public class Config {
    ...
    public static final boolean SMART_FORWARD_FEATURE = true;
    public static final boolean TAB_ONLINE_FEATURE = true;
    public static final boolean TAB_SCHEDULED_FEATURE = true;
    ...
    public static final boolean PROFILE_IMAGE_COLLECTION_FEATURE = true;
    public static final boolean V2T_FEATURE = true;
    public static final boolean MEDIA_FEATURE = true;
    public static final boolean BIG_REFRESH_LOGIN_FEATURE = false;
    public static final boolean PROXY_SPONSOR_FEATURE = true;
    public static final boolean PROXY_SMART_FEATURE = true;
    public static final boolean TOOLBAR_SHADOW_FEATURE = false;
    ...
    public static final boolean SHAKE_FEATURE = true;
    public static final boolean HIDE_MODE_FAKE_PASS_FEATURE = true;
    public static final boolean FAKE_PHONE_FEATURE = true;
    public static final boolean INFO_IN_CHATS_FEATURE = true;
    public static final boolean DRAWER_SETTING_FEATURE = true;
    public static final boolean GHOST_MODE_FEATURE = true;
    public static final boolean TRANSPARENT_STATUSBAR_FEATURE = true;
    public static final boolean DIALOG_BOTTOM_MENU_FEATURE = true;
    ...
    public static final boolean DRAWER_GRID_FEATURE = true;
...
//endregion
    ...
    public static boolean getDialogsDefaultIcons(SharedStorage.keys key) {
        return SharedStorage.keys.OPEN_ARCHIVE != key
                ...
                && SharedStorage.keys.CLOUD_IN_CHAT != key
    ...
    public static final String DRAWER_HIDE_ITEMS = String.format("%s,%s",
    ...
    public static final String DIALOG_BOTTOM_MENU_HIDE_ITEMS = String.format("%s",
            DialogBottomMenuLayoutAdapter.Type.FIX_X.ordinal()
            /*DialogBottomMenuLayoutAdapter.Type.HIDE_MENU.ordinal()*/
    );
    //endregion

    public static final int ICON_CUSTOM_SETTINGS = R.drawable.ic_custom_setting;
    public static final int ICON_CONTACT_CHANGES = R.drawable.ic_user_changes;
    public static final int ICON_PEOPLE_NEARBY = R.drawable.ic_people_nearby;
    public static final int ICON_ADDMOB = R.drawable.ic_admob_logo;
    public static final int ICON_GHOST_MENU = R.drawable.ic_ghost_off;
    public static final int GHOST_ON_ICON = R.drawable.ic_ghost_on;
    public static final int GHOST_OFF_ICON = R.drawable.ic_ghost_off;
    public static final int ICON_ALL_DIALOGS_TAB = R.drawable.msg_media;
