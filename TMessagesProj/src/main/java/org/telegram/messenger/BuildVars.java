...
public class BuildVars  extends com.finalsoft.Config {
    ...
    public static int BUILD_VERSION = 3138;
    public static String BUILD_VERSION_STRING = "9.4.3";
    ...
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=" + BuildConfig.APPLICATION_ID;
